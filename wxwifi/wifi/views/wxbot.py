...
class WXBot(threading.Thread):
    ...
    def __init__(self):
        ...
        self.conn = psycopg2.connect(database="smartlinkcloud", user="quanpower", password="caojing1010", host="127.0.0.1", port="5432")
        ...
        #文件缓存目录
        self.temp_pwd  =  os.path.join(os.getcwd(),'static')
    ...
    def get_contact(self):
        ...
        r.encoding = 'utf-8'
        self.contact_list = []
        self.contact_list.append(r.text.encode('utf-8'))
        ...
        # self.cur.execute(
        #     'INSERT INTO robot (user_name,account_info,contact_list,contacts,group_list,group_users,member_list,public_list,special_list) VALUES ({0},{1},{2},{3},{4},{5},{6},{7},{8})'.format(self.my_account['UserName'], self.account_info, self.contact_list, self.contacts, self.group_list, self.group_members, self.member_list, self.public_list, self.special_list)
        #     )
        # self.conn.commit()
        # self.conn.close()
